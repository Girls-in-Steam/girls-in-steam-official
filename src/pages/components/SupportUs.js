        ...
        <Grid item sm={12} md={6}>
          <div>
            ...
            <div className="SupportSectionContainer">
              ...
              <Typography variant="body1">
                💌 Email us at <a href="mailto:info@girlsinsteam.org">info@girlsinsteam.org</a> if
            ...
            <div className="SupportSectionContainer">
              ...
              <Box
                ...
                <a href="https://www.instagram.com/girlsinsteamorg/">
                  <img className="social-icon" alt="Instagram logo" src={ig}></img>
                </a>
                <a href="https://www.facebook.com/girlsinsteamorg/">
                  <img className="social-icon" alt="Facebook logo" src={fb}></img>
                </a>
                <a href="https://www.youtube.com/@girlsinsteam">
                  <img className="social-icon" alt="YouTube logo" src={yt}></img>
                </a>
                <a href="https://www.linkedin.com/company/girlsinsteam/">
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ display: 'flex', justifyContent: 'center' }}>
            <img
              ...
              src={thermometer}
              alt="Donation tracker thermometer"
            />
          </Box>
        </Grid>
      </Grid>
